...
export declare type Spawnable<TContext, TEvent extends EventObject = AnyEventObject> = StateMachine<any, any, TEvent> | Promise<TContext> | InvokeCallback | Subscribable<TContext>;
export {};
