import { StateMachine, Event, EventObject, DefaultContext, StateSchema, StateValue, InterpreterOptions, DoneEvent, Unsubscribable, MachineOptions, SCXML, EventData, Observer, Spawnable, AnyEventObject } from './types';
import { State } from './State';
import { Actor, ServiceActor } from './Actor';
...
export declare class Interpreter<TContext, TStateSchema extends StateSchema = any, TEvent extends EventObject = EventObject> implements Actor<State<TContext, TEvent>, TEvent> {
    ...
    private exec;
    private stopChild;
    spawn(entity: Spawnable<any, any>, name: string, options?: SpawnOptions): Actor;
...
export declare function spawn<TContext, TEvent extends EventObject>(entity: StateMachine<TContext, any, TEvent>, nameOrOptions?: string | SpawnOptions): ServiceActor<TContext, TEvent>;
export declare function spawn<TContext, TEvent extends EventObject = AnyEventObject>(entity: Exclude<Spawnable<TContext>, StateMachine<any, any, any>>, nameOrOptions?: string | SpawnOptions): Actor<TContext, TEvent>;
/**
